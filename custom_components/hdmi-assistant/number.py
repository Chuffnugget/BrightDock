# File: number.py
# Description: Manages number entities (brightness, contrast, input) for HDMI Assistant.
# Author: Chuffnugget
...
class AssistantNumber(CoordinatorEntity, NumberEntity):
    """Representation of a DDC/CI control (brightness, contrast, input) under HDMI Assistant."""
